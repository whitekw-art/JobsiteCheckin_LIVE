      ...
      <main style={{ maxWidth: '760px', margin: '0 auto', padding: '64px 48px 96px' }}>
        ...
        <Section title="4. Acceptable Use">
          ...
          <ul>
            ...
            <li>Upload, publish, or share private personal information belonging to any third party, including homeowner names, addresses, contact details, or financial information.</li>
            <li>Upload photographs of documents containing third-party personal or financial information, including invoices, purchase orders, work orders, delivery receipts, contracts, or billing records.</li>
            <li>Upload or publish inappropriate, obscene, sexually explicit, violent, discriminatory, or otherwise objectionable images or content.</li>
            <li>Use content generated by our AI features for any purpose other than its intended use within the Service.</li>
        ...
        <Section title="5. Your Content">
          ...
          <p>You are solely responsible for all content you choose to publish publicly through the Service. ProjectCheckin is a publishing platform, not a publisher. We do not review content before publication and are not responsible for the accuracy, legality, or appropriateness of content you choose to make publicly visible.</p>
          <p><strong>You are responsible for what appears in the photos you upload.</strong> Photos you submit may be published on public job pages, transmitted to our AI provider for analysis if you use an AI feature, and published to your own website if you have connected one. You agree not to upload photographs containing the private information of third parties — including customer names, addresses, phone numbers, financial data, pricing, or any visible document such as an invoice, work order, purchase order, or contract. You bear sole responsibility and risk for any such information you choose to upload, and for any consequence of it being processed or published.</p>
          <p>We do not review photographs for personal information before they are processed or published, and we have no obligation to do so.</p>
          <p>We may use automated tools to screen content for inappropriate material before or after publication. When content is flagged, we may notify you and require its removal. We are not obligated to pre-screen content, and we reserve the right to remove any content that violates these Terms at our discretion.</p>
          <p><strong>Copyright complaints.</strong> If you believe content on the Service infringes your copyright, send a written notice to <a href={`mailto:${CONTACT_EMAIL}`} style={{ color: '#0EA5E9' }}>{CONTACT_EMAIL}</a> including: (a) identification of the copyrighted work; (b) identification of the allegedly infringing content and its URL; (c) your contact information; (d) a statement that you have a good faith belief the use is not authorized by the copyright owner, its agent, or the law; and (e) your physical or electronic signature. We will respond promptly to valid notices and may remove the content in question.</p>
        </Section>

        <Section title="6. AI Features and Generated Content">
          <p>ProjectCheckin uses artificial intelligence to help generate job descriptions and other content based on the job details and photos you provide (&ldquo;AI-Generated Content&rdquo;). You are responsible for reviewing all AI-Generated Content before publishing it. We make no warranty that AI-Generated Content is accurate, complete, or free from error. You must not publish AI-Generated Content containing inaccurate product information, pricing, or any third-party information you cannot independently verify.</p>
          <p>When you use an AI feature, the relevant job details and job photos are transmitted to our third-party AI provider (OpenAI) for analysis. This happens only when you actively choose to use an AI feature. If a photograph you upload contains personal, financial, or document information, that information is transmitted as part of the photo, and you are responsible for that choice. OpenAI&apos;s handling of transmitted data is governed by OpenAI&apos;s API data usage policies; as of the effective date of these Terms, data submitted through their API is not used to train their models. We do not sell your content, and we do not use your job photos or descriptions to train any model of our own.</p>
        </Section>

        <Section title="7. Publishing to Your Own Website (Titan plan)">
        ...
        <Section title="8. Subscriptions and Payment">
          <ul>
            ...
            <li>You may cancel your subscription at any time. Cancellation takes effect at the end of the current billing period. No partial refunds are issued for unused time except where required by our guarantee (see Section 9).</li>
        ...
        <Section title="9. Results Guarantee">
        ...
        <Section title="16. Termination">
          <p>We may suspend or terminate your access to the Service at any time for violation of these Terms or for any other reason at our discretion, with or without notice. Upon termination, your right to use the Service ceases immediately. Sections 5, 6, 7, 10, 11, 12, 13, and 14 survive termination.</p>
        </Section>
